...
#include "common/platformdetect.h"
...
#define LAB_LOG_TRACE(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::trace, __VA_ARGS__), LAB_LOG_TRACE_('\n'))
#define LAB_LOG_DEBUG(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::debug, __VA_ARGS__), LAB_LOG_DEBUG_('\n'))
#define LAB_LOG_INFO(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::info, __VA_ARGS__), LAB_LOG_INFO_('\n'))
#define LAB_LOG_WARN(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::warn, __VA_ARGS__), LAB_LOG_WARN_('\n'))
#define LAB_LOG_ERROR(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::err, __VA_ARGS__), LAB_LOG_ERROR_('\n'))
#define LAB_LOG_FATAL(...) (SPDLOG_LOGGER_CALL(::lab::common::Logger::get_core_logger(), spdlog::level::level_enum::critical, __VA_ARGS__), LAB_LOG_FATAL_('\n'))
#else
